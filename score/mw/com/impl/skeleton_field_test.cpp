...
TEST(SkeletonFieldTest, NotCopyable)
{
    ...
    static_assert(!std::is_copy_constructible<SkeletonField<TestSampleType, WithGetter, WithNotifier>>::value,
                  "Is wrongly copyable");
    static_assert(!std::is_copy_assignable<SkeletonField<TestSampleType, WithGetter, WithNotifier>>::value,
                  "Is wrongly copyable");
}
...
TEST(SkeletonFieldTest, IsMoveable)
{
    ...
    static_assert(std::is_move_assignable<SkeletonField<TestSampleType, WithGetter, WithNotifier>>::value,
