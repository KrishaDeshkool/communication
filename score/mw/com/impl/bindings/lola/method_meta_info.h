...
/// \details Normally proxies/skeletons or "user code" dealing with a method know its signature. This info is
///          provided and placed into shared-memory for the GenericProxy use-case, where a proxy connects to a provided
///          service based on only deployment info, NOT having any knowledge about the exact data types of the
///          method's in-args or return value.
